"""
simulacao_tesouro_ipca_vs_carteira_30_30_15_25_sem_xpml.py
...
4) Carteira alternativa:
   - 30% Ações
   - 30% BDRs
   - 15% FIIs, removendo XPML11
...
Execução:
    python simulacao_tesouro_ipca_vs_carteira_30_30_15_25_sem_xpml.py

Saída:
    saida_tesouro_ipca_vs_carteira_30_30_15_25_sem_xpml/
"""
...
def plot_bar(summary_real: pd.DataFrame, output_path: Path) -> None:
    itens = ["Ações", "BDRs", "FIIs sem XPML11", "Tesouro IPCA+4,5%", "Carteira 30/30/15/25 sem XPML11"]
    ...
    ax.set_title("Retorno real acumulado acima do IPCA - Carteira 30/30/15/25")
...
def main() -> None:
    ...
    output_dir = Path("saida_tesouro_ipca_vs_carteira_30_30_15_25_sem_xpml")
    ...
    for janela, start in janelas.items():
        ...
        carteira = build_weighted_portfolio({
            ...
            "BDRs": (bdrs, PESO_BDRS),
            "FIIs sem XPML11": (fiis, PESO_FIIS),
            "Tesouro IPCA+4,5%": (tesouro_series, PESO_TESOURO),
        }, "Carteira 30/30/15/25 sem XPML11")
        ...
        for label, serie in [
            ...
            ("Carteira 30/30/15/25 sem XPML11", carteira),
        ]:
        ...
        if not df_plot.empty:
            ...
            plot_lines(
                df_plot,
                f"IPCA, Tesouro IPCA+4,5 e carteira 30/30/15/25 sem XPML11 - {janela}",
    ...
    excel_path = output_dir / "tesouro_ipca_vs_carteira_30_30_15_25_sem_xpml.xlsx"
