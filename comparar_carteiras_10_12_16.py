"""
Comparação de três carteiras brasileiras:
1) TOP 10 do ranking Buy and Hold
2) Nova carteira com 12 ativos e menor redundância
3) Todos os 16 ativos da lista
...
def primeira_data_comum(precos: pd.DataFrame, tickers: list[str], inicio_desejado: pd.Timestamp) -> pd.Timestamp:
    ...
    Essa regra evita criar uma carteira antes de todos os seus ativos existirem.
    """
